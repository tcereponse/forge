...
const PLATFORMS = {
    DEEPSEEK: {
        ...
        sendBtn: ['.ds-input-send-button', '[aria-label*="send" i]', '[data-testid="send-button"]', 'div[role="button"][aria-label*="send" i]', 'div[role="button"][title*="send" i]'],
    ...
    GEMINI: {
        ...
        sendBtn: ['button[aria-label*="Send" i]', '.send-button'],
    ...
    FALLBACK: {
        ...
        sendBtn: ['button[type="submit"]', 'button[aria-label*="send" i]', 'button[aria-label*="envo" i]'],
